...
Every non-OMO row is INCOMPLETE, prior OMO claim (TRIGGER 0/9 ×2) stands.
...
| ZCode | 10/11 spawn errors (model/captcha/quota) | Clear quota, install-then-start-session, retry — cheapest third-harness close. |
